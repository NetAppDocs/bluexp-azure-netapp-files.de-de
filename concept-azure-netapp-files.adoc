...
https://bluexp.netapp.com/cloud-volumes-global-regions["Unterstützte Azure Regionen anzeigen"^]
...
* link:https://bluexp.netapp.com/azure-netapp-files["Azure NetApp Files auf der NetApp BlueXP Website"^]
* link:https://learn.microsoft.com/azure/azure-netapp-files/["Azure NetApp Files-Dokumentation"^]
* link:https://docs.netapp.com/us-en/bluexp-copy-sync/index.html["Dokumentation der BlueXP Kopier- und Synchronisierungsfunktion"^]
